...
import * as LearningMaterialRepo from "../../../shared/repository/learning-material";
...
export async function store(req: Request, res: Response) {
    ...
    const result = await LearningMaterialRepo.insert(body);
...
export async function get(req: Request, res: Response) {
    ...
    const result = await LearningMaterialRepo.find(query);
...
export async function updateById(req: Request, res: Response) {
    ...
    await LearningMaterialRepo.update(id, body);
...
export async function deleteById(req: Request, res: Response) {
    ...
    await LearningMaterialRepo.remove(id);
