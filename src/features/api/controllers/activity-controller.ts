...
import * as ActivityRepo from "../../../shared/repository/activity";
...
export async function store(req: Request, res: Response) {
    ...
    const result = await ActivityRepo.insert(body);
...
export async function get(req: Request, res: Response) {
    ...
    const result = await ActivityRepo.find(query);
...
export async function updateById(req: Request, res: Response) {
    ...
    await ActivityRepo.update(id, body);
