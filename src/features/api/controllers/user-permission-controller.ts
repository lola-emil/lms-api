...
import * as UserPermissionRepo from "../../../shared/repository/user-permission";
...
export async function store(req: Request, res: Response) {
    ...
    const result = await UserPermissionRepo.insert(body);
...
export async function get(req: Request, res: Response) {
    ...
    const result = await UserPermissionRepo.find(query);
...
export async function updateById(req: Request, res: Response) {
    ...
    await UserPermissionRepo.update(id, body);
...
export async function deleteById(req: Request, res: Response) {
    ...
    await UserPermissionRepo.remove(id);
